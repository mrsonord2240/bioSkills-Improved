...
| Which kinases moved? | KSEA or PTM-SEA (`## Kinase Activity with KSEAapp`, `## PTM-SEA With ssGSEA2.0`) with a curated prior; do not over-interpret dark-kinome silence | Prior-limited; simple z-score suffices |
