...
5. Flag multiplets; decide to filter or analyze as combinatorial
6. Standard normalization
7. Apply Mixscape escaper filtering with NTC controls
8. Verify KO retention rate (see SKILL.md's Quantitative Thresholds)
9. Per-perturbation DE via SCEPTRE with covariates
